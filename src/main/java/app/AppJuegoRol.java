...
public class AppJuegoRol {
    ...
    // personajeService.listarPorUsuario(usuarioLogueado.getId());
    ...
    // String raza = Utils.pideDatoCadena("Elige raza (MONGOL, RAPA NUI,
    // TROGLODITA): ");

    // personajeCreado = personajeService.crearYGuardar(usuarioLogueado.getId(),
    // name, raza);
    ...
    // break;
    // }
    // System.out.println("Sesión cerrada del usuario: " +
    ...
    // }
    // if (personajeCreado == null || personajeCreado.getId() == null) {
    // System.out.println("Debes seleccionar/crear un personaje primero (login y
    // elegir personaje, o crear con opción 5).");
    // break;
    // }
    ...
    // EquipamientoDto añadido =
    // equipamientoService.añadirAlInventario(personajeCreado.getId(), nuevo);
    // System.out.println("OK: añadido -> " + añadido);

    // System.out.println("\nInventario (DTO) del personaje " +
    // personajeCreado.getNombre() + ":");
    // List<EquipamientoDto> inv =
    // equipamientoService.listarPorPersonaje(personajeCreado.getId());
    ...
    // if (personajeCreado != null && personajeCreado.getId() != null) {
    // System.out.println("Personaje activo detectado: " +
    // personajeCreado.getNombre()
    ...
    // if (idPersonaje == null) {
    // idPersonaje = Long.valueOf(Utils.pideDatoNumerico("Introduce el ID del
    // personaje a recargar: "));
    // }
    ...
    // System.out.println("\n--- CRIATURAS (" +
    // personajeCreado.getCriaturas().size() + ") ---");
    ...
    // System.out.println("10) TEST: RECARGAR PERSONAJE Y MOSTRAR INVENTARIO /
    // CRIATURAS (PERSISTENCIA)");
    // }
    // }
