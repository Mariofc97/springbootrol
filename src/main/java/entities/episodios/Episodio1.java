...
public class Episodio1 {
	...
	public void episodio1(Personaje personaje, AccionesEpisodio acciones) {
		...
		acciones.add("Despiertas en una cueva. No recuerdas tu nombre… pero sí tu olor.");
		acciones.add("Un eco te susurra: 'Para sobrevivir necesitas llorar, pensar y NO morir.'");
